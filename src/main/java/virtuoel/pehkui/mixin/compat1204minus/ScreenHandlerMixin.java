...
public class ScreenHandlerMixin
{
	...
	private static double pehkui$canUse$xOffset(double value, PlayerEntity player, Block block, World world, BlockPos pos)
	{
	...
	private static double pehkui$canUse$yOffset(double value, PlayerEntity player, Block block, World world, BlockPos pos)
	{
	...
	private static double pehkui$canUse$zOffset(double value, PlayerEntity player, Block block, World world, BlockPos pos)
	{
